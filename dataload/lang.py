...
tag_PAD = 0
tag_UNK = 1
defaltTokken = {tag_PAD: "<PAD>", tag_UNK: "<UNK>"}
class Lang:
    def __init__(self, name, defaltTokken=defaltTokken):
        self.name = name
        self.tag_PADid = tag_PAD
        
        self.word2index = {}
        self.word2count = {}
        self.index2word = defaltTokken.copy() # {tag_UNK: "<UNK>", tag_PAD: "<PAD>"}
        self.n_words = len(self.index2word) # 2  # UNK 와 PAD 포함
        self.max_len_word = 0
        
        self.char2index = {}
        self.char2count = {}
        self.index2char = defaltTokken.copy() # {tag_UNK: "<UNK>", tag_PAD: "<PAD>"}
